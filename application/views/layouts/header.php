        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $path.'admin/'.$this->session->userdata['image'];?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata['adminname'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $path.'admin/'.$this->session->userdata['image'];?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php echo ($page=='pengguna')?'class="active"':'';?>><a href="<?php echo site_url('pengguna');?>"><i class="fa fa-user"></i> <span>PENGGUNA</span></a></li>
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;">
            <li <?php echo ($page=='dokumen')?'class="active"':'';?>><a  href="<?php echo site_url('dokumen');?>"><i class="fa fa-file-text"></i>All Dokumen</a></li>
              <li <?php echo ($page=='surat_masuk')?'class="active"':'';?>><a  href="<?php echo site_url('surat_masuk');?>">- <i class="fa fa-file-text"></i>Surat Masuk
              <?php if(!empty($hitung)){ ?>
                <small class="label pull-right bg-red"><?php echo $hitung;?></small>
              <?php ;} ?>
              </a></li>
              <li <?php echo ($page=='surat_keluar')?'class="active"':'';?>><a  href="<?php echo site_url('surat_keluar');?>">- <i class="fa fa-file-text"></i>Surat Keluar</a></li>
          </ul>
        </li>
        <li <?php echo ($page=='contact_us')?'class="active"':'';?>><a href="<?php echo site_url('contact_us');?>"><i class="fa fa-phone"></i> <span>Contact Us</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>