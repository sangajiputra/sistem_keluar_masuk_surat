                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('pengguna/actionadd');?>">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="des_admin" rows="3" placeholder="Enter ..."></textarea>
                                        </div>
