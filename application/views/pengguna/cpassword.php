                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Pengguna > Change Password</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('pengguna/actioncpassword');?>">
                                    <div class="box-body">
